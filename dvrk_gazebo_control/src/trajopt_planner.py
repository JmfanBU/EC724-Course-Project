...
class Planner(object):
	...
	def __init__(self, task):
		...
		# initialize robot and empty environment
        	...
        	env.StopSimulation()
        	env.Load("/home/jiameng/catkin_AIM/src/dvrk_env/dvrk_model/Two_Link/arm_model.zae")
	...
	def table_features(self, waypt):
		...
		"""
		if len(waypt) < 10:
			waypt = np.append(waypt.reshape(2))
...
"""
	...
	# ---- here's trajOpt --- #
		...
		"""
		if len(start) < 3:
			aug_start = np.append(start.reshape(2))
